...
class ArrayList(List):
    ...
    def resize(self):
        """
          ...
          """
        one = np.zeros(max(1, 2 * self.n), object)
    ...
    def set(self, i: int, x: object) -> object:
        ...
        if i < 0 or i >= self.n:
            raise IndexError()
        temp = self.a[(self.j + 1) % len(self.a)]
    ...
    def add(self, i: int, x: object):
        ...
        if i < (self.n / 2):
            for k in range(0, i):
                self.a[(k + self.j - 1) % len(self.a)] = self.a[(self.j + k) %
                                                                len(self.a)]
            self.j = ((self.j - 1) % len(self.a))
        else:
            for k in range(self.n - 1, i - 1, -1):
                self.a[(self.j + k + 1) % len(self.a)] = self.a[(self.j + k) %
                                                                len(self.a)]
        self.a[(self.j + i) % len(self.a)] = x
        self.n += 1
    ...
    def remove(self, i: int) -> object:
        ...
        if i < (self.n / 2):
            for k in range(i, 0, -1):
                self.a[(self.j + k) % len(self.a)] = self.a[(self.j + k - 1) %
                                                            len(self.a)]
            self.j = ((self.j + 1) % len(self.a))
        else:
